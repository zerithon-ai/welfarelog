    ...
    <MobileLayout>
      <div className="p-4 space-y-6">
        ...
        <div className="flex items-center space-x-3">
          ...
          <h1 className="text-2xl font-bold text-gray-900">근무 설정</h1>
        </div>

        <div className="bg-white rounded-lg shadow-sm border p-4">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold text-gray-900">근무 타입 관리</h2>
            <Button
              variant="primary"
              size="sm"
          ...
          {isAddingWorkType && (
            <form onSubmit={handleSubmit} className="mb-6 p-4 bg-gray-50 rounded-lg space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">근무 이름</label>
                <input
                  type="text"
                  value={formData.name}
          ...
          <div className="space-y-3">
            {workTypes.length === 0 ? (
              <div className="text-center py-8 text-gray-500">
                ...
                <p className="text-sm text-gray-400 mt-1">근무 타입을 추가해보세요!</p>
              </div>
            ) : (
              workTypes.map((workType) => (
                <div key={workType.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div className="flex items-center space-x-3">
                    <div
                    ...
                    />
                    <div>
                      <p className="font-medium text-gray-900">{workType.name}</p>
